...
import 'package:ecommerce_depi/feature/details/pages/producr_details.dart';
import 'package:ecommerce_depi/feature/explore/widget/assets_or_network.dart';
...
class ItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigations.naviagationPush(context, ProducrDetails(product: model));
      },
      child: Container(
